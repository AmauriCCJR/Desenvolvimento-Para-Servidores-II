async function cadastro(){
    ...
    try {
        const response = await fetch('../Sala/inserir', {method:'POST', headers: {'Content-Type': 'application/json'}, 
...
async function carregarDados() {
    try {
        const response = await fetch('../Sala/consultar', {method: 'POST', headers: {'Content-Type': 'application/json'}, 
            body: JSON.stringify({
                codigo: '',
                descricao: '',
                andar: '',
...
async function editarSala(){
    ...
    try{
        ...
        const response = await fetch ('../Sala/alterar', {method:'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({
            codigo: codigo,
            descricao: descricao,
            andar: andar,
